...
<form method="post" action="">
	Enter your birthday:
	<br>
	Month: <input type="number" name="month" value="<?= $_SERVER["REQUEST_METHOD"]==="POST" &&$_POST["month"];?>">
	<span class="error"><?= $month_error;?>		</span>
  <br>
	Day: <input type="number" name="day" value="<?= $_SERVER["REQUEST_METHOD"]==="POST" &&$_POST["day"];?>">
  <span class="error"><?= $day_error;?>		</span>
	<br>  
	Year: <input type="number" name="year" value="<?= $_SERVER["REQUEST_METHOD"]==="POST" &&$_POST["year"];?>">  
